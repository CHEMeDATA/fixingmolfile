let writeFileSync,readFileSync,existsSync,join;_07c‍.w("fs",[["writeFileSync",["writeFileSync"],function(v){writeFileSync=v}],["readFileSync",["readFileSync"],function(v){readFileSync=v}],["existsSync",["existsSync"],function(v){existsSync=v}]]);_07c‍.w("path",[["join",["join"],function(v){join=v}]]);
